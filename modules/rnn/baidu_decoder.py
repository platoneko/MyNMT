...
from modules.baidu_attention import Attention
from modules.rnn.baidu_state import DecoderState
from utils.pack import Pack
from modules.utils import get_sequence_mask
...
class RNNDecoder(nn.Module):
    ...
    def initialize_state(self,
        ...
        if memory_lengths is not None and attn_mask is None:
            ...
            attn_mask = get_sequence_mask(memory_lengths, max_len).eq(0)
    ...
    def forward(self, inputs, state):
        ...
        num_valid_list = get_sequence_mask(sorted_lengths).int().sum(dim=0)
